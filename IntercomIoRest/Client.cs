...
namespace IntercomIoRest
{
    ...
    public class Client : IDisposable
    {
        ...
        /// <summary>Occurs when [succeeded].</summary>
        ...
        /// </summary>
        /// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="Client"/>. The
        /// <see cref="Dispose"/> method leaves the <see cref="Client"/> in an unusable state. After calling
        /// <see cref="Dispose"/>, you must release all references to the <see cref="Client"/> so the garbage
        /// collector can reclaim the memory that the <see cref="Client"/> was occupying.</remarks>
        public void Dispose()
        {
