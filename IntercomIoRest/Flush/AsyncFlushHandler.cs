...
namespace IntercomIoRest.Flush
{
	internal class AsyncFlushHandler : IFlushHandler
	{
		...
		/// </summary>
		/// <remarks>Call <see cref="Dispose"/> when you are finished using the <see cref="AsyncFlushHandler"/>. The
		/// <see cref="Dispose"/> method leaves the <see cref="AsyncFlushHandler"/> in an unusable state.
		/// After calling <see cref="Dispose"/>, you must release all references to the
		/// <see cref="AsyncFlushHandler"/> so the garbage collector can reclaim the memory that the
		/// <see cref="AsyncFlushHandler"/> was occupying.</remarks>
		public void Dispose()
		{
